...
const createModelStateFromPartialModelState = (
  ...
  const modelState: ModelState = {
    ...
    palette: partialModelState?.palette ? partialModelState.palette : [],
    associationPopup: partialModelState?.associationPopup
      ? partialModelState.associationPopup
      : { sourceObjectId: '', isIconObjectDiagram: false, isOpen: false },    editor: {
